    ...
    function drawStars() {
        ...
        stars.forEach(function (star) {
            const opacity = 0.3 + 0.7 * (
                0.5 + 0.5 * Math.sin(
                    animationTime * star.speed * 60 + star.phase
                )
            );
...
(function () {
    const targetDate =
        new Date("2026-09-02T09:30:00+05:30").getTime();
    const countdownIds = ["cdDays", "cdHours", "cdMins", "cdSecs"];
...
(function () {
    ...
    ["Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat"].forEach(
        function (day) {
            ...
            dayElement.className = "cal-day-name";
...
(function () {
    ...
    weddingSong.play().catch(function (error) {
